    ...
    public class SIP_ClientTransaction : SIP_Transaction
    {
        ...
        internal SIP_ClientTransaction(SIP_Stack stack, SIP_Flow flow, SIP_Request request) : base(stack, flow, request)
        {
            ...
            if (Stack.Logger != null)
            {
                Stack.Logger.AddText(ID,
                                     "Transaction [branch='" + ID + "';method='" + Method + "';IsServer=false] created.");
            }
                ...
                */
                ...
                if (Stack.Logger != null)
                {
                    ...
                    Stack.Logger.AddRead(
                        ...
                        null,
                        0,
                        "Response [transactionID='" + ID + "'; method='" + response.CSeq.RequestMethod + "'; cseq='" +
        ...
        private void SendCancel()
        {
            ...
            */
            ...
            SIP_ClientTransaction transaction = Stack.TransactionLayer.CreateClientTransaction(Flow, cancelRequest,
                                                                                               false);
            transaction.Start();
        }
