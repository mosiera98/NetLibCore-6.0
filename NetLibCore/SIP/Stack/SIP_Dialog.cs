    ...
    public class SIP_Dialog
    {
        ...
        protected internal virtual void Init(SIP_Stack stack, SIP_Transaction transaction, SIP_Response response)
        {
            ...
            */
            ...
            if (transaction is SIP_ServerTransaction)
            {
                ...
                m_pRouteSet =
                    (SIP_t_AddressParam[]) Net_Utils.ReverseArray(transaction.Request.RecordRoute.GetAllValues());
        ...
        public SIP_Request CreateRequest(string method)
        {
            ...
            */
            ...
            lock (m_pLock)
            {
                SIP_Request request = m_pStack.CreateRequest(method, new SIP_t_NameAddress("", m_pRemoteUri),
            ...
            else if (e.Request.CSeq.SequenceNumber < m_RemoteSeqNo)
            {
                e.ServerTransaction.SendResponse(
                    Stack.CreateResponse(
                        ...
                        ": The mid-dialog request is out of order(late arriving request).", e.Request));
        ...
        internal void AddTransaction(SIP_Transaction transaction)
        {
            ...
            transaction.Disposed += delegate { m_pTransactions.Remove(transaction); };
        }
        ...
        /// </summary>
        /// <exception cref="ObjectDisposedException">Is raised when this class is Disposed and this property is accessed.</exception>
        public IEnumerable<SIP_Transaction> Transactions
        {
            get
            {
                if (State == SIP_DialogState.Disposed)
