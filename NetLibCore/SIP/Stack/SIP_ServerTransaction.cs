    ...
    public class SIP_ServerTransaction : SIP_Transaction
    {
            ...
            */
            ...
            lock (SyncRoot)
            {
                if (State == SIP_TransactionState.Completed)
                {
                    ...
                    try
                    {
                        Stack.TransportLayer.SendResponse(this, this.FinalResponse);
            ...
            */
            ...
            lock (this.SyncRoot)
            {
                if (this.State == SIP_TransactionState.Completed)
                {
                    ...
                    {
                        this.Stack.Logger.AddText(this.ID,
                                                  "Transaction [branch='" + this.ID + "';method='" + this.Method +
                        ...
                        if (this.State == SIP_TransactionState.Proceeding)
                        {
                            ...
                            else if (response.StatusCodeType == SIP_StatusCodeType.Success)
                            {
                                ...
                                */
                                ...
                                {
                                    this.Stack.Logger.AddText(this.ID,
                                                              "Transaction [branch='" + this.ID + "';method='" +
                                                              this.Method +
        ...
        public override void Cancel()
        {
            lock (this.SyncRoot)
            {
                ...
                try
                {
                    SIP_Response response = this.Stack.CreateResponse(SIP_ResponseCodes.x487_Request_Terminated,
                                                                      this.Request);
                    this.Stack.TransportLayer.SendResponse(this, response);
                ...
                try
                {
                    ...
                    if (this.Stack.Logger != null)
                    {
                        ...
                        this.Stack.Logger.AddRead(
                            ...
                            null,
                            0,
                            "Request [transactionID='" + this.ID + "'; method='" + request.RequestLine.Method +
                            "'; cseq='" + request.CSeq.SequenceNumber + "'; " +
                            "transport='" + flow.Transport + "'; size='" + requestData.Length + "'; received '" +
