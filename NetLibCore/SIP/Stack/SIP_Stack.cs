...
namespace NetLib.SIP.Stack
{
    ...
    public class SIP_Stack
    {
        ...
        public SIP_Stack()
        {
            ...
            m_pAllow.AddRange(new[] {"INVITE", "PRACK", "ACK", "UPDATE", "CANCEL", "BYE", "OPTIONS", "INFO", "SUBSCRIBE", "REFER", "NOTIFY"});
            ...
            */
            ...
            while (true)
            {
                ...
                foreach (SIP_Transaction tr in m_pTransactionLayer.Transactions)
                {
                    ...
                    if (tr.State == SIP_TransactionState.WaitingToStart || tr.State == SIP_TransactionState.Calling ||
                        tr.State == SIP_TransactionState.Proceeding || tr.State == SIP_TransactionState.Trying)
                    {
        ...
        public SIP_Request CreateRequest(string method, SIP_t_NameAddress to, SIP_t_NameAddress from)
        {
            ...
            */
            ...
            var f = new SIP_t_From(from) {Tag = SIP_Utils.CreateTag()};
            request.From = f;
            ...
            */
            ...
            request.CallID = method == SIP_Methods.REGISTER
                                 ? m_RegisterCallID.ToStringValue()
                                 : SIP_t_CallID.CreateCallID().ToStringValue();
            ...
            */
            ...
            // Allow,Supported (section 13.2.1)
            ...
            // Pre-configured route (proxy server)
        ...
        /// </summary>
        /// <param name="statusCodeReasonText">Status-code reasontext.</param>
        /// <param name="request">SIP request.</param>
        ...
        public SIP_Response CreateResponse(string statusCodeReasonText, SIP_Request request, SIP_Flow flow = null)
        {
            if (request == null)
            {
                throw new ArgumentNullException("request");
            ...
            */
            ...
            var response = new SIP_Response(request) {StatusCode_ReasonPhrase = statusCodeReasonText};
            ...
            if (SIP_Utils.MethodCanEstablishDialog(request.RequestLine.Method))
            {
                ...
                if (response.Contact.GetTopMostValue() == null && flow != null)
                {
                    ...
                    response.Contact.Add((flow.IsSecure ? "sips:" : "sip:") + user + "@" + flow.LocalPublicEP);
                }
            }
        ...
        /// <exception cref="ArgumentException">Is raised when any of the arguments has invalid value.</exception>
        public SIP_UA_Registration CreateRegistration(SIP_Uri server, string aor, AbsoluteUri contact,
                                                      int expires = 3600)
        {
            if (m_State == SIP_StackState.Disposed)
            {
