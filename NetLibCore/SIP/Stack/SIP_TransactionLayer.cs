...
namespace NetLib.SIP.Stack
{
    ...
    public class SIP_TransactionLayer
    {
                ...
                var via = new SIP_t_ViaParm
                              {
                                  ProtocolName = "SIP",
                                  ProtocolVersion = "2.0",
                                  ProtocolTransport = flow.Transport,
                                  SentBy = new HostEndPoint("transport_layer_will_replace_it", -1),
        ...
        public SIP_ServerTransaction EnsureServerTransaction(SIP_Flow flow, SIP_Request request)
        {
            ...
            */
            ...
            lock (m_pServerTransactions)
            {
                ...
                return retVal ?? CreateServerTransaction(flow, request);
            }
        }
        ...
        /// </summary>
        public IEnumerable<SIP_Dialog> Dialogs
        {
            get
            {
                lock (m_pDialogs)
