...
namespace NetLib.UDP
{
    ...
    public class UDP_DataReceiver : IDisposable
    {
        ...
        public UDP_DataReceiver(Socket socket, bool useTask = false)
        {
...
//            {
//                EndPoint rtpRemoteEP = new IPEndPoint(m_pSocket.AddressFamily == AddressFamily.InterNetwork ? IPAddress.Any : IPAddress.IPv6Any, 0);
//                m_pSocket.BeginReceiveFrom(m_pBuffer, 0, m_BufferSize, SocketFlags.None, ref rtpRemoteEP, AsyncSocketReceive, new StateObject { WorkingSocket = m_pSocket, Buffer = m_pBuffer, BufferSize = m_BufferSize });
//            }
        }
